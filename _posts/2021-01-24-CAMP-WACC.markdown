...
# 0.39000579600491575 * 31.21083354949951 = 12.172405982449487
...
## 2.2 가중평균자본비용 (Weighted Average Cost of Capital, WACC)

$$ \begin{align}
\text{WACC} &= \frac{\text{E}}{\text{E} + \text{D}} \times R_E + \frac{D}{\text{E} + \text{D}} \times R_D \\
R_E &= \text{CAMP} \\
R_D &= (R_f + \text{Credit Spread}) \times (1-\text{Tax Rate})
\end{align} $$
 ...
 - $$ R_D $$: Cost of Debt (타인자본조달비용) 
    - 
    - 은행의 대출은 Loan, 회사채는 Bond
    - $$ \text{} $$   
 - $$ 1 - \text{Tax Rate} $$: 실효세율을 적용합니다.    
