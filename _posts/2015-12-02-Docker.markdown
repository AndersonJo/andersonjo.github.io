...
| Vivid 15.04        | deb https://apt.dockerproject.org/repo ubuntu-vivid main  |
...
#### [Error] [graphdriver] prior storage driver \"aufs\" failed: driver not supported

{% highlight bash %}
m -rf /var/lib/docker/aufs
{% endhighlight %}
