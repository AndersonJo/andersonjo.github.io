...
## 2.2 Custom Ingress Gateway

- [Setting up custom ingress gateway](https://knative.dev/docs/serving/setting-up-custom-ingress-gateway/) 참조


{% highlight yaml %}
cat <<EOF > custom-ingressgateway.yaml
...
{% highlight bash %}
$ curl -H "Host:helloworld-python.default.ai.platform" http://a7a33739ba44140b0a39d7cce1cae118-1000758165.us-east-2.elb.amazonaws.com
{% endhighlight %}
