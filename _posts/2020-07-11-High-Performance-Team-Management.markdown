...
3. A급 인원하고는 어차피 이래저래 말할일 많으니까,  B급 C급 인원들이 절대 소외받거나 존중받지 않는다는 생각이 들도록 더 많은 시간을 할애한다
...
3. 결론을 작성해주세요. 팀원또는 다른 부서의 사람이 과정까지 알 필요는 없는 경우가 많습니다. 그냥 결과만 보면 됩니다. 
4. 자세한 과정을 공유 
...
먼저 프로세스 과정중에서 가장 시간이 많이 걸리는 부분을 체크해놓고 문제를 해결해야 합니다. <br>
...
특히 실서비스에서 문제가 발생했을때 잘못된 문제 해결은 실수한 사람에 대한 비난입니다. <br>
(물론 그 사람이 빈번하게 문제를 일으킨다면.. 이야기는 다름.. 항상 이해해주는것이 덕목은 아닙니다.)<br>
포스트모템 또한 문서로 전사에 공유를 합니다. 

발생시간, 최초 알게 된 사람, 누가 대응을 어떻게 했는지, 등등 -> **핵심은 근원적 문제를 파악하는 것**입니다. <br>
