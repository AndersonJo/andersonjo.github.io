...
## 1.2 Ray Job Submission for Test
...
## 1.3 Submitting a Ray Job in Python
...
ray.init('localhost:8265', include_dashboard=True)
...
## 2.1 Deleting a Ray Cluster & KubeRay Operator
