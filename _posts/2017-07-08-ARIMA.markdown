...
<img src="{{ page.asset_path }}arima_passenger_data.png" class="img-responsive img-rounded">
...
<img src="{{ page.asset_path }}arima_ar_statsmodels.png" class="img-responsive img-rounded">
...
<img src="{{ page.asset_path }}arima_ols_summary.png" class="img-responsive img-rounded">

<img src="{{ page.asset_path }}arima_ols_result.png" class="img-responsive img-rounded">
...
<img src="{{ page.asset_path }}arima_ar_poly.png" class="img-responsive img-rounded">
