...
<img src="{{ page.asset_path }}anogan.png" class="img-responsive img-rounded">
...
<img src="{{ page.asset_path }}anogan_smooth_transition.png" class="img-responsive img-rounded">
