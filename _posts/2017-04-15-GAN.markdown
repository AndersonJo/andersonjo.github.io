...
<img src="{{ page.asset_path }}gan.png" class="img-responsive img-rounded">
...
<img src="{{ page.asset_path }}gan_distribution.png" class="img-responsive img-rounded">
...
<img src="{{ page.asset_path }}gan_algorithm.png" class="img-responsive img-rounded">
...
<img src="{{ page.asset_path }}gan_loss.png" class="img-responsive img-rounded" style="margin: 0 auto;">
</div>
...
<img src="{{ page.asset_path }}gan_eva1.png" class="img-responsive img-rounded">

<div style="text-align:center;">
<img src="{{ page.asset_path }}gan_eva2.png" class="img-responsive img-rounded" style="margin: 0 auto;">
</div>
