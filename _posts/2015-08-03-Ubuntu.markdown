...
이후 Startup Applications 에서 다음을 추가

- Name: Xmodmap
- Command: xmodmap ~/.Xmodmap

<img src="{{ page.asset_path }}xmodmap.png" class="img-responsive img-rounded img-fluid center" style="border: 2px solid #333333">
...
2. Korean - Hangul >> Preferences >> Hangul 추가

<img src="{{ page.asset_path }}input-method-korean-hangul.png" class="img-responsive img-rounded img-fluid center" style="border: 2px solid #333333">
